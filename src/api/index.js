...
export const getCheckPoints = (tradeId, elementId) => api.get(`/checkpoints?tradeId=${tradeId}${elementId ? `&elementId=${elementId}` : ''}`)
...
export const adminGetCheckPoints = (tradeId, elementId) => api.get(`/admin/checkpoints${tradeId ? `?tradeId=${tradeId}${elementId ? `&elementId=${elementId}` : ''}` : ''}`)
...
export const adminGetMatrix = (params) => api.get('/admin/matrix', { params })
